# This code contains the neural network models used for the communication security demonstration.
...
class Sender_NN(torch.nn.Module):
    def __init__(self, D_in, H):
        super(Sender_NN, self).__init__()
        self.fc_layer = torch.nn.Linear(D_in, H)
        self.conv1 = torch.nn.Conv1d(in_channels=1, out_channels=2, kernel_size=4, stride=1, padding=2)
