...
class plot:
    ...
    def MorandiColor(self,mode,**kwargs):
        ...
        color_dict = {
                      ...
                      'Truered':    self.CMYK_to_RGB(0,75,75,20),
                      ...
                      'Seablue':    self.CMYK_to_RGB(60,20,2,8),
        ...
        if 'label' in kwargs:
            if curve == 'scatter':  # 'scatter'字符串可以控制画散点图
                ...
                plt.plot(x, y, linestyle=linestyle, linewidth=linewidth, color=color, alpha=alpha,
                         markerfacecolor='w',
                         marker=marker, markersize=markersize_spline, label=kwargs['label'], zorder=zorder)
            else:
                plt.plot(x, y, linestyle=linestyle, linewidth=linewidth, color=color, alpha=alpha,
            ...
            if curve == 'scatter':  # 'scatter'字符串可以控制画散点图
                ...
                plt.plot(x,y,linestyle=linestyle,linewidth=linewidth,color=color,alpha=alpha,marker=marker,
                         markerfacecolor='w',
                             markersize=markersize_spline,zorder=zorder)
            else:
